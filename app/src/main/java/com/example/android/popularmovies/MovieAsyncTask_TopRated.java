...
class MovieAsyncTask_TopRated extends AsyncTask<String, Void, Movie[]> {

    private final String LOG_TAG = MovieAsyncTask_TopRated.class.getSimpleName();
    private final String mApiKey;
    private final OnTaskCompleted mListener;


    public MovieAsyncTask_TopRated(OnTaskCompleted listener, String apiKey) {
        super();
        mListener = listener;
        mApiKey = apiKey;
    }
...
//        final String tmdbUrl = "https://api.themoviedb.org/3/discover/movie?";
        final String tmdbUrl = "http://api.themoviedb.org/3/movie/top_rated?";
